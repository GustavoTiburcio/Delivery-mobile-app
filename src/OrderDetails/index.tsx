...
function OrderDetails({ route }: Props) {
  ...
  const handleConfirmDelivery = () => {
    ...
    .catch(() => {
        Alert.alert(`Houve um erro ao tentar confirmar entrega do pedido ${order.id}`);
    })
 }
    ...
    <>
        ...
        <View style= {styles.container}>
            ...
            <RectButton style={styles.button}>
                <Text style={styles.buttonText} onPress={handleStartNavigation}>INICAR NAVEGAÇÃO</Text>
            </RectButton>
